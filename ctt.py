...
def help(v):
  if v[0] == "flag":
    print '   std::cerr << " '+v[1]+' := tipo bool "',
    print " << std::endl ;"
    print '   std::cerr << "--> '+v[2]+'"',"<< std::endl;"
    print '   std::cerr << "    Valor por defecto : false" << std::endl;',
    return
  print '   std::cerr << "'+v[2]+' := tipo ',v[1],'"',
  print " << std::endl ;"
  if v[0] == "val":
    print '   std::cerr << "--> '+v[4]+'"',"<< std::endl;"
    print '   std::cerr << "    Valor por defecto : ' + v[3].replace('"','\\"')+'"',

  if v[0] == "choice":
    print '   std::cerr << "--> '+v[4]+'"',"<< std::endl;"
    posValues=v[3].split(",")
    print '   std::cerr       << "    Possible values are: " << ','<< " " <<'.join([i   for i in posValues]),
  print " << std::endl ;"
  print
...
#   print lineas
 ...
 #    print backend
     for linea_h in open(os.path.expanduser("~/opt/etc/ctt/%s.be.h"%backend)):
...
#   if useNamespaces:
  ...
  # if useNamespaces:
   ...
   if createInit:
     ...
     print """//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"""
     print """//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"""
     print "void CTGlobal::initialize_program(int &argc, char** & argv){"
     ...
     print """    filein = nameArg.getValue();"""
     print """    quietRun = quietSwitch.getValue();"""
     print """    if(! quietRun) verbosityLevel = verboseMSwitch.getValue();"""
     print

     print
     print """ } catch (TCLAP::ArgException &e) """
     print """ { cerr << "error: " << e.error() << " for arg " << e.argId() << endl; }"""
     print """ """
     print """  """
     print """  if(!quietRun) {"""
     print """    std:: cerr << "\\n< " << argv[0] << " > version: "<< VERSION_NUMBER  ;"""
     print """    std:: cerr << " ( released on: "<< RELEASE_DATE << " )" <<  std::endl;"""
     print """    std:: cerr << "< " << argv[0] << " > compiled on: "<< __DATE__  ;"""
     print """    std:: cerr << " "<< __TIME__ <<  std::endl;"""
     print """  }"""
     print
     print """ if(filein != "" ){"""
